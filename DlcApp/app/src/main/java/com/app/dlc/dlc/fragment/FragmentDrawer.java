package com.app.dlc.dlc.fragment;
...
import com.app.dlc.dlc.adapter.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (LoggedInUser.getType().equals("distributeur"))
            ...
            titles = getActivity().getResources().getStringArray(R.array.nav_drawer_utlisateur);
